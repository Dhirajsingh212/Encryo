    ...
    <div className='pl-4 pr-0'>
      ...
      >
        <Button
          ...
          className='group relative flex w-full flex-col gap-4 overflow-hidden border border-purple-400/50 bg-gradient-to-br from-purple-600 to-pink-500 py-20 transition-all duration-300 hover:from-purple-500 hover:to-pink-400 lg:h-[84vh]'
        >
          <motion.div
