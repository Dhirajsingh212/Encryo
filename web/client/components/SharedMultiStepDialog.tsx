...
import { addFileToSharedProject } from '@/actions/sharedProject'
...
const SharedMultiStepDialog = () => {
  ...
  const submitHandler = async () => {
    try {
      ...
      const response = await addFileToSharedProject(
        formData,
        path.split('/')[2],
        userId,
        selectValue
...
export default SharedMultiStepDialog
