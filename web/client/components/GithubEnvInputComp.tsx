...
import { deleteGithubEnvById, udpateGithubEnvById } from '@/actions/githubEnv'
...
export default function GithubEnvInputComp({
  pairs,
  index
}: {
  pairs: Envs
  ...
  const handleDelete = async () => {
    try {
      ...
      const response = await deleteGithubEnvById(pairs.id)
  ...
  const handleUpdate = async () => {
    try {
      ...
      const response = await udpateGithubEnvById(userId, pairs.id, name, value)
      if (response) {
